import { version as version$1, unref, inject, defineComponent, ref, provide, createElementBlock, defineAsyncComponent, h, computed, shallowReactive, watch, Suspense, nextTick, Transition, hasInjectionContext, shallowRef, toRef, getCurrentInstance, onServerPrefetch, mergeProps, useSSRContext, createApp, effectScope, reactive, isRef, isReactive, toRaw, getCurrentScope, onScopeDispose, onErrorCaptured, createVNode, resolveDynamicComponent, isReadonly, toRefs, markRaw, isShallow, withCtx } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, h as createError$1, n as hash, o as defu, q as sanitizeStatusCode, r as createHooks, t as klona, v as parse, x as getRequestHeader, y as destr, z as isEqual, A as setCookie, B as getCookie, C as deleteCookie, D as getRequestHeaders } from '../nitro/node-server.mjs';
...
factory(esm.throttle);
factory(esm.debounce);
...
var DollarApollo = /*#__PURE__*/function () {
  ...
  _createClass(DollarApollo, [{
    ...
    value: function addSmartQuery(key, options) {
      ...
      if (finalOptions.prefetch !== false) {
        smart.autostart();
      }
      return smart;
    }
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/_slug_-D5RDblKA.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/index-CJsTkZA6.mjs').then((m) => m.default || m)
  }
];
...
const LazyButton = defineAsyncComponent(() => import('./_nuxt/Button-CcRvJmD0.mjs').then((r) => r.default));
const LazyLogo = defineAsyncComponent(() => import('./_nuxt/Logo-CLZrQW71.mjs').then((r) => r.default));
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-BGBVQ4UO.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-vMW3EmxC.mjs').then((r) => r.default));
...
const layouts = {
  default: () => import('./_nuxt/default-D-mKakGV.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-RITWRMdK.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-ClxBxE1W.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-D1F4wu8U.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useRouter as a, useRuntimeConfig as b, createError as c, defineStore as d, entry$1 as default, navigateTo as e, useNuxtApp as f, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useAsyncQuery as u };
