import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version as version$1, unref, h, shallowRef, shallowReactive, isReadonly, ref, markRaw, watch, isRef, isReactive, toRaw, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, onServerPrefetch, defineComponent, provide, createElementBlock, isShallow, defineAsyncComponent, Suspense, mergeProps, Transition, withCtx, createVNode, useSSRContext, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
...
import { wrap as wrap$1, dep, Slot } from "optimism";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_slug_-zW2X5vTB.js").then((m) => m.default || m)
  },
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    ...
    component: () => import("./_nuxt/_slug_-Dbt8hlHK.js").then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    ...
    component: () => import("./_nuxt/index-BlmofH9H.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-BgKGQaKM.js").then((m) => m.default || m)
  }
];
...
const LazyButton = defineAsyncComponent(() => import("./_nuxt/Button-Dk0SEWd0.js").then((r) => r.default));
const LazyLogo = defineAsyncComponent(() => import("./_nuxt/Logo-Bcv9aqW1.js").then((r) => r.default));
const LazyAppArticle = defineAsyncComponent(() => import("./_nuxt/Article-C0fbYq3Z.js").then((r) => r.default));
const LazyAppCTA = defineAsyncComponent(() => import("./_nuxt/CTA-BclgPkM1.js").then((r) => r.default));
const LazyAppContent = defineAsyncComponent(() => import("./_nuxt/Content-DJzfkvwB.js").then((r) => r.default));
const LazyAppContentImage = defineAsyncComponent(() => import("./_nuxt/ContentImage-CcVQ8hjl.js").then((r) => r.default));
const LazyAppHero = defineAsyncComponent(() => import("./_nuxt/Hero-c6_BeMDw.js").then((r) => r.default));
const LazyAppRow = defineAsyncComponent(() => import("./_nuxt/Row-Bt2lqYG0.js").then((r) => r.default));
const LazyAppSocials = defineAsyncComponent(() => import("./_nuxt/Socials-CKHqkLop.js").then((r) => r.default));
const LazyAppText = defineAsyncComponent(() => import("./_nuxt/Text-BGL1b7U3.js").then((r) => r.default));
const LazyAppFooterMenu = defineAsyncComponent(() => import("./_nuxt/Menu-CYVT0ukf.js").then((r) => r.default));
const LazyAppNavigationHamburger = defineAsyncComponent(() => import("./_nuxt/Hamburger-D0JWet9x.js").then((r) => r.default));
const LazyAppNavigationMenu = defineAsyncComponent(() => import("./_nuxt/Menu-BOyfRoux.js").then((r) => r.default));
const LazyAppNavigationMenuItem = defineAsyncComponent(() => import("./_nuxt/MenuItem-Dm4q3hxU.js").then((r) => r.default));
const LazyAppNavigationRoutes = defineAsyncComponent(() => import("./_nuxt/Routes-9WMb8CGj.js").then((r) => r.default));
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-b-GbGTYZ.js").then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-CXCbN9N-.js").then((r) => r.default));
const lazyGlobalComponents = [
  ["Button", LazyButton],
  ["Logo", LazyLogo],
  ["AppArticle", LazyAppArticle],
  ["AppCTA", LazyAppCTA],
  ["AppContent", LazyAppContent],
  ["AppContentImage", LazyAppContentImage],
  ["AppHero", LazyAppHero],
  ["AppRow", LazyAppRow],
  ["AppSocials", LazyAppSocials],
  ["AppText", LazyAppText],
  ["AppFooterMenu", LazyAppFooterMenu],
  ["AppNavigationHamburger", LazyAppNavigationHamburger],
  ["AppNavigationMenu", LazyAppNavigationMenu],
  ["AppNavigationMenuItem", LazyAppNavigationMenuItem],
  ["AppNavigationRoutes", LazyAppNavigationRoutes],
  ["Icon", LazyIcon],
  ["IconCSS", LazyIconCSS]
];
...
const NuxtApollo = {
  ...
  clients: { "default": { "connectToDevTools": true, "httpEndpoint": "https://graphql.prepr.io/8ceca1fc2030dffb820fd8fc322328bb3e40a4b45333ffa9d773caa799f5adab", "authType": "Bearer", "authHeader": "Authorization", "tokenName": "apollo:default.token", "tokenStorage": "cookie", "defaultOptions": void 0 } }
};
...
const layouts = {
  default: () => import("./_nuxt/default-CvLjL02d.js").then((m) => m.default || m),
  homepage: () => import("./_nuxt/homepage-szZW5-Qd.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Dbh30Fgi.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-ClxBxE1W.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-D1F4wu8U.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
