...
<template>
  <div v-if="data.Hero" class="relative flex flex-col-reverse grid-cols-12 md:gap-4 md:grid">
    ...
    >
      <div class="flex flex-col col-span-6 col-start-2 gap-6 md:gap-8">
        <h1 class="h2 hyphens-auto lg:hyphens-none lg:h1">{{ data.Hero.title }}</h1>
